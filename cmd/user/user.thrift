...
service UserInfo {
    UserResponse Register(1:string username ,2 : string password )
    UserResponse Login(1:string username ,2 : string password )
    UserResponse UserInfo(1:string token ,2 : i64 user_id )
}